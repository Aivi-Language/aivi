...
Inside a patch block, `-` means “remove the selected field”. Database row deletion is separate and uses `db.delete table[pred]` from [`aivi.database`](../stdlib/system/database.md).
