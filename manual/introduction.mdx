---
title: "AIVI Language Specification (v0.1)"
description: "AIVI is a statically typed, purely functional language designed for high-integrity data pipelines and domain-driven design."
---
## Overview
...
See [External Sources](/language/external-sources) and the per-source guides under [Source Integrations](/language/sources/file).
