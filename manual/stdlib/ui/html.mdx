---
title: "HTML Sigil (`~<html>...</html>`)"
description: "The ~<html>...</html> sigil allows embedding HTML inside Aivi code:syntax and lowers it to aivi.ui.VNode msg constructors."
---
