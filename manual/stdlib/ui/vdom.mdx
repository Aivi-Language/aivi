---
title: "UI Virtual DOM"
description: "The aivi.ui module defines a typed Virtual DOM . Programs construct VNode trees and leave rendering + diffing to the runtime."
---
...
view = name => Element "div" [Class "greeting"] [TextNode "Hello {name}"]
```
