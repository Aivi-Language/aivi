---
title: "Email Module"
description: "The email module provides IMAP inbox access and SMTP delivery. Use imap to fetch messages and smtpSend to send them."
---
