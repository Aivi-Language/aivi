---
title: "HTTPS Domain"
description: "The Https domain mirrors Http, but enforces secure  connections. It is intended for production use where transport security is required."
---
