---
title: "Sockets Domain"
description: "The Sockets domain exposes low-level TCP/UDP sockets for custom protocols and long-lived connections."
---
...
<!-- /quick-info -->
<Note>use aivi.net.sockets</Note>
