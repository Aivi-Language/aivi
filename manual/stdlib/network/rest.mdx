---
title: "REST Module"
description: "The rest module is a higher-level HTTP client tailored for consuming JSON REST APIs. Compared to aivi.net.http, it adds built-in bearer-token auth, per-request"
---
