---
title: "Duration Domain"
description: "The Duration domain provides a type-safe way to represent Spans of Time."
---
...
<!-- /quick-info -->
<Note>use aivi.chronos.duration<span class="domain-badge">domain</span></Note>

## Overview

```aivi
use aivi.chronos.duration (Duration)
