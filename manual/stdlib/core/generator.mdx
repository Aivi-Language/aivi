...
description: "The aivi.generator module provides utilities for AIVI generators."
---
...
<!-- /quick-info -->
<Note>use aivi.generator</Note>


## Overview

```aivi
use aivi.generator as Gen

xs = Gen.range 0 5 |> Gen.toList
// xs == [0, 1, 2, 3, 4]
```
