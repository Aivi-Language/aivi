---
title: "Units Domain"
description: "The Units domain brings Dimensional Analysis to your code, solving the "Mars Climate Orbiter" problem. A bare number like 10 is dangerous is it meters? seconds?"
---
...
<!-- /quick-info -->
<Note>use aivi.units<span class="domain-badge">domain</span></Note>
