---
title: "Collections"
description: "The collections family provides persistent data structures for functional code. Each data structure lives in its own module:"
---
...
<!-- /quick-info -->
<Note>use aivi.collections</Note>
