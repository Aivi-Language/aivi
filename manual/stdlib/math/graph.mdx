---
title: "Graph Domain"
description: "The Graph domain is for modelling Relationships and Networks."
---
...
<!-- /quick-info -->
<Note>use aivi.graph<span class="domain-badge">domain</span></Note>

## Overview

```aivi
use aivi.graph (fromEdges, bfs)
