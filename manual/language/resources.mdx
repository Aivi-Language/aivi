...
description: "AIVI provides a dedicated Resource type to manage lifecycles  in a declarative way. This ensures that resources like files, sockets, and database connections ar"
---
...
Resources interact with the cancellation system (see [Concurrency](/runtime/concurrency)):
