---
title: "`@static` — Compile-Time Evaluation"
description: "@static evaluates deterministic source reads at compile time and embeds the value into the program as a constant. No runtime overhead."
---
