---
title: "3.6 Expected-Type Coercions (Instance-Driven)"
description: "In some positions, the surrounding syntax provides an expected type (for example, function arguments,"
---
