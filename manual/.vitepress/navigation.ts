...
const howToSection: DocSection = {
  ...
  items: [
    ...
    { text: 'Contribute to AIVI', link: '/how-to/contribute' },
  ],
}
...
const referenceSection: DocSection = {
  ...
  items: [
    ...
    {
      text: 'Tooling and delivery',
      collapsed: true,
      items: [
        { text: 'Toolchain & Artifacts', link: '/reference/toolchain-and-artifacts' },
        { text: 'Diagnostics & Editor Tooling', link: '/reference/editor-tooling' },
...
const stdlibSections: DocSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Secret Storage', link: '/stdlib/secret' },
      { text: 'Tray Bridge', link: '/stdlib/tray' },
      ...
      { text: 'Pixel Dimensions', link: '/stdlib/px' },
      { text: 'Icon Names', link: '/stdlib/icons' },
