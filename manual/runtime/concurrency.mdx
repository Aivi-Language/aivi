---
title: "Runtime: Concurrency and Communication"
description: "AIVI implements a Structural Concurrency model by default, ensuring that the lifecycle of concurrent tasks is strictly bound to the lexical scope that created t"
---
...
```aivi
Sender A // Capability to send values of type A
Receiver A // Capability to receive values of type A
```
