---
title: "Missing Features & Gap Analysis (v0.1)"
description: "This page tracks documentation and implementation gaps between the specs/ and the current compiler/runtime in crates/."
---
...
- `on` statement in `do Effect { ... }` blocks: listed in the [grammar](/language/grammar) but semantics are not documented in any syntax chapter.
...
| Module | File                                  | Status                                           |
|:------ |:------------------------------------- |:------------------------------------------------ |
| Log    | [system/log.md](/stdlib/system/log) | Implemented in runtime v0.1; covered by integration tests |
