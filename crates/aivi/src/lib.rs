...
pub mod surface {
    pub use aivi_core::{
        ...
        ArenaLiteral, ArenaMatchArm, ArenaModule, ArenaModuleItem, ArenaPathSegment, ArenaPattern,
        ArenaRecordField, ArenaRecordPatternField, ArenaRecordTypeField, ArenaScopeItem,
        ...
        Def, DomainDecl, DomainItem, Expr, FlowAnchor, FlowArm, FlowBinding, FlowGuard, FlowLine,
        FlowModifier, FlowStep, FlowStepKind, InstanceDecl, ListItem, Literal, MatchArm, Module,
        ModuleItem, PathSegment, Pattern, RecordField, RecordPatternField, RecordTypeField,
        ScopeItemKind, SpannedName, SpannedSymbol, TextPart, TypeAlias, TypeCtor, TypeDecl,
...
pub mod hir {
    pub use aivi_core::{
        CompiledAggregate, CompiledDbPatchField, CompiledDbPatchPlan, CompiledOrderBy,
        CompiledProjection, CompiledProjectionField, CompiledQueryPlan, CompiledQuerySource,
        CompiledScalarExpr, HirBlockItem, HirBlockKind, HirDef, HirExpr, HirListItem, HirLiteral,
        HirMatchArm, HirMockSubstitution, HirModule, HirPathSegment, HirPattern, HirProgram,
        HirRecordField, HirRecordPatternField, HirTextPart,
    };
...
pub use aivi_core::{
    ...
    ArenaExpr, ArenaInstanceDecl, ArenaListItem, ArenaLiteral, ArenaMatchArm, ArenaModule,
    ArenaModuleItem, ArenaPathSegment, ArenaPattern, ArenaRecordField, ArenaRecordPatternField,
    ArenaRecordTypeField, ArenaScopeItem, ArenaTextPart, ArenaTypeAlias, ArenaTypeCtor,
