...
uniqueNodeIdsHelp = items seen accRev => items ?
  | [] => reverse accRev
  | [x, ...rest] =>
...
fromWeightedEdgesHelp = g triples => triples ?
  | [] => g
...
removeEdgeHelp = edge edges => edges ?
  | [] => []
...
removeNodeHelp = node nodes => nodes ?
  | [] => []
...
removeNodeEdgesHelp = node edges => edges ?
  | [] => []
  | [e, ...rest] =>
...
isValidEdges = nodes edges => edges ?
  | [] => True
...
inNeighborsHelp = node edges => edges ?
  | [] => []
...
edgesFromHelp = node edges => edges ?
  | [] => []
...
bfsVisitNeighbors = idx goal parent ns q visited parents => ns ?
...
dfsLoop = idx visited stack outRev => stack ?
  | [] => reverse outRev
  | [node, ...rest] =>
