...
pub(crate) fn register_builtins(env: &Env) {
    ...
    env.set(
        "__db_query_compiled".to_string(),
        super::database::build_query_compiled_builtin(),
    );
    env.set(
        "__db_query_count".to_string(),
        super::database::build_query_count_builtin(),
    );
    env.set(
        "__db_query_exists".to_string(),
        super::database::build_query_exists_builtin(),
    );
    env.set(
