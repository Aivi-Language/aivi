...
pub use hir::{
    ...
    IntegerLiteral, Item, ItemHeader, ItemKind, MarkupAttribute, MarkupAttributeValue,
    MarkupElement, MarkupNode, MarkupNodeKind, MatchControl, Module, ModuleArenas, Name, NameError,
    NamePath, NamePathError, Pattern, PatternKind, PipeExpr, PipeStage, PipeStageKind,
    ...
    TermReference, TermResolution, TextLiteral, TypeField, TypeItem, TypeItemBody, TypeKind,
